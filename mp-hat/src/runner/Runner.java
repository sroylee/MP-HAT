...
public class Runner {
	...
	static void predict(String datasetPath, String resultPath, String mode, String setting, int nTopics, int testBatch,
		...
		evaluation.Prediction prediction = new Prediction(datasetPath, resultPath, mode, setting, nTopics,
	...
	public static void main(String[] args) {
		try {
			if (args[0].equals("gen")) {
				...
				if (predMode == 0) {
					predict(datasetPath, resultPath, mode, setting, topics, testBatch, PredictionMode.HAT, outputPath);
				} else if (predMode == 1) {
